...
Review this implementation against the spec and context docs. Read these files first:

- `_bmad-output/implementation-artifacts/spec-fix-default-assistant-model-on-create.md`
- `CLAUDE.md`
- `docs/references/naming-conventions.md`
- `tests/__mocks__/README.md`
- `docs/references/testing/database-testing.md`

Check acceptance criteria, repo rules, test adequacy, and scope control. Return only findings with severity and file/line references.
